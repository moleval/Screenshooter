...
Описание: Функции для работы с виртуальным экраном (мультимониторность).
          Позволяют получить объединённую геометрию всех экранов и сделать
          скриншот всего виртуального рабочего стола.
"""
