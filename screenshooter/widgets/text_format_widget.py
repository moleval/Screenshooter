...
class TextFormatWidget(QFrame):
    ...
    def __init__(self, parent=None):
        ...
        self.bg_white_btn.setObjectName("bgWhiteBtn")
        ...
        self.bg_black_btn.setObjectName("bgBlackBtn")
        ...
        self.bg_none_btn.setObjectName("bgNoneBtn")
