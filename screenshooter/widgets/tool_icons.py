"""
Модуль: widgets/tool_icons.py
Описание: Функции генерации иконок для инструментов и кнопок.
          Создаёт QIcon для указателя, прямоугольника, эллипса, стрелки, текста,
          линий, а также для режимов под-тулбаров и кнопок редактирования
          (обрезка, поворот, размытие).
"""
