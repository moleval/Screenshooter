"""
Модуль: items/line_items.py
Описание: Элементы линий.
          LineItem — прямая или пунктирная линия.
          WavyLineItem — волнистая линия, генерируемая синусоидой.
          Поддерживают стиль пера, выделение и перемещение.
"""
