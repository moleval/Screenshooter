...
from PyQt5.QtWidgets import (QGraphicsItem, QGraphicsPathItem, QGraphicsItemGroup,
                             QGraphicsLineItem, QGraphicsTextItem, QStyle)
from ..constants import HIT_AREA_PADDING
from .text_item import DimensionTextItem
...
class DimensionItem(QGraphicsItemGroup):
    ...
    def __init__(self, start, end, pen, text_color):
        ...
        self._custom_text = None   # хранит пользовательский текст
    ...
    def build_items(self, start, end):
        ...
        self._text_item = DimensionTextItem(self, text)
